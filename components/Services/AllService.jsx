...
const AllService = () => {
  return (
    <div className="bg-white">
      <div className="max-w-[1296px]  mx-auto pt-[120px] pb-10 md:pb-[297px] flex flex-col md:flex-row flex-wrap gap-6">
        {services.map(({ id, title, desc, img }) => (
          ...
          >
            <Image
              ...
              alt="service img"
            />
            <div className="px-[30px] pt-4 pb-8">
              <h2 className="text-2xl font-semibold mb-[23px]">{title}</h2>
