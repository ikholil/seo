...
const Solution = () => {
  return (
    <div className="bg-[#FFFDFA]">
      <div className="max-w-[1296px] mx-auto py-20 md:pt-[110px] md:pb-[120px] ">
        <div className="flex justify-center">
          <div className="max-w-[640px] text-center">
            <h3 className="text-[32px] font-bold text-[#FF5349]">
              Marketing Solution
            </h3>
            <h2 className="text-4xl md:text-[57px] font-bold leading-tight text-[#222] mt-[13px] mb-[10px]">
        ...
        <div className="md:grid md:grid-cols-12 md:gap-10">
          ...
          <div className="col-span-12 mx-3 xl:mx-0 flex flex-col mt-5 md:mt-0 gap-7 lg:col-span-6">
            {solution.map(({ id, desc, icon, title }) => (
              <div
                className={`p-4 md:px-[30px] pt-[30px] pb-[28px] flex flex-col lg:flex-row gap-[30px] rounded-lg ${
                  id == 1 && "bg-[#EDEFF5]"
