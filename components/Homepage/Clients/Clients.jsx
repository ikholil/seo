...
const Clients = () => {
  return (
    <div className="bg-[#F9F9F9]">
      <div className="max-w-[1296px] mx-auto py-20 md:pt-[115px] pb-[120px]">
        <div className="flex justify-center">
          <div className="max-w-[640px] text-center">
            <h3 className="text-2xl font-bold text-[#FF5349]">
              clients’s love
            </h3>
            <h2 className="text-4xl md:text-[43px] font-bold leading-tight text-[#222] mb-2 mt-[13px]">
              Our Trusted <span className="text-[#FF5349]">{"Client's"}</span>
            </h2>
            <p className="text-lg mb-[57px] text-[#222]">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit.
            </p>
          </div>
        </div>
        <div className="flex flex-col gap-5  md:flex-row justify-between items-center flex-wrap">
            {
