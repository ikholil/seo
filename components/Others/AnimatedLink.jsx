...
const AnimatedLink = (props) => {
  return (
    <a className={`px-5 py-3 md:px-6 relative z-10 md:py-4 cursor-pointer  rounded-[5px] shadow-lg shadow-[#ff6f2c65] hover:shadow-none group overflow-hidden bg-[#FF6E2C] text-white inline-block ${props.classes}`}>
