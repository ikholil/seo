  ...
  return (
    <div className="pt-[80px] bg-white md:pt-[100px]  relative">
      ...
      <div className="bg-[#1A4DBE] min-h-[435px]">
        <div className="bg-[url('/images/seo/banner-bg.png')] bg-[length:300px_200px] md:bg-[length:650px_400px] md:block xl:right-80 absolute  w-full  bg-no-repeat bg-right-bottom min-h-[435px]"></div>
